...
from torchvision.ops.boxes import _box_cxcywh_to_xyxy, _box_xyxy_to_cxcywh

from .head import DynamicHead, aligned_bilinear
from .loss import SetCriterionDynamicK, HungarianMatcherDynamicK, parse_dynamic_params
...
class DiffusionInst(nn.Module):
    ...
    def forward(self, batched_inputs, do_postprocess=True):
        ...
        if self.training:
            ...
            output = {'pred_logits': outputs_class[-1], 'pred_boxes': outputs_coord[-1],
                      ...
                      'aux_outputs': [{'pred_logits': a, 'pred_boxes': b, 'pred_kernels': c, 'mask_feat': mask_feat}
    ...
    def prepare_diffusion_concat(self, gt_boxes):
        ...
        diff_boxes = _box_cxcywh_to_xyxy(x)
    ...
    def prepare_targets(self, targets):
        ...
        for targets_per_image in targets:
            ...
            gt_boxes = _box_xyxy_to_cxcywh(gt_boxes)
